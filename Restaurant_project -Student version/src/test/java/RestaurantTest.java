...
class RestaurantTest {
    ...
    public void setup() {
        ...
        restaurant.addToMenu("Vegetable lasagne", 230);
        restaurant.addToMenu("French fries", 100);
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time() {
        ...
        Mockito.when(spiedRestaurant.getCurrentTime()).thenReturn(LocalTime.parse("12:30:00"));
